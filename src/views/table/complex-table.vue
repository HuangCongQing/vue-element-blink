<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-select v-model="listQuery.DefectPos" placeholder="DefectPos" clearable class="filter-item" style="width: 130px">
        <el-option v-for="item in DefectPosOptions" :key="item" :label="item" :value="item" />
      </el-select>
    ...
    >
      ...
      <el-table-column label="CiwaType" width="100px" align="center">
        <template slot-scope="{row}">
          <span class="link-type">{{ row.title }}</span>
        </template>
      </el-table-column>
      <el-table-column label="MachineNum" width="150px" align="center">
        <template slot-scope="{row}">
      ...
      <el-table-column label="MaterialNum" width="190px" align="center">
        <template slot-scope="{row}">
...
<script>
import { fetchList, fetchPv, createArticle, updateArticle } from '@/api/article' // 数据接口
  ...
  methods: {
    getList() {
      ...
      fetchList(this.listQuery).then(response => {
        this.list = response.data.items // 获取列表数据
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        const tHeader = ['timestamp', 'CiwaType', 'MachineNum', 'MaterialNum', 'DefectType', 'DefectPos', 'Accepted'] // 对应接口数据名字
        const filterVal = ['timestamp', 'title', 'author', 'importance', 'pageviews', 'DefectPos', 'Accepted']
